...
func (s WebsocketServer) getBearerToken(c *gin.Context) (string, error) {
...
func (s WebsocketServer) AuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		claims, err := s.llqClient.ValidateToken(token)
		if err != nil {
