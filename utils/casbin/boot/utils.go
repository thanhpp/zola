...
func BootstrapDaemons(ctx context.Context, daemonGenerators ...utils.DaemonGenerator) {
	// os signal handling
...
func (d *daemonManager) registerDaemon(g utils.DaemonGenerator) {
	if g != nil {
...
func (d *daemonManager) registerDaemons(gs ...utils.DaemonGenerator) {
	for _, g := range gs {
		d.registerDaemon(g)
	}
}
